...
public class DateUtils {
    ...
    public static long[] getDistanceTime(String str1, String str2) throws ParseException {
        ...
        return getDistanceTime(df.parse(str1), df.parse(str2));
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(DateUtils.getDateYmdHms());
            System.out.println(DateUtils.getDateHms());
        } catch (Exception e) {
